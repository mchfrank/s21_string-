...
void input_flags(struct token *S);
void un_flags(struct token *S);
char *sprintf_spec_f(struct token *S, char *str, long double num);
char *oxX_sprintf(struct token *S, char *str, int num);
char *loxX_sprintf(struct token *S, char *str, long int num);
char *sprintf_spec_c(struct token *S, char *str, int C);
char *sprintf_spec_s(struct token *S, char *str, char *C);
char *ls_sprintf(struct token *S, char *str, wchar_t *C);
char *sprintf_spec_u(struct token *S, char *str, s21_size_t num);
char *p_convert(long x, int hex);
char *sprintf_spec_d(struct token *S, char *str, int num);
